(function(root) {
    ...
    */
    var Fov = function Fov(game) {
        ...
        this._fov = new ROT.FOV.RecursiveShadowcasting(this.checkVisible);
    ...
    Fov.prototype = {
        ...
        */
		...
		update90: function(x, y, dir){
            this.fovMap.reset();
            var _this = this;
            this._fov.compute90(x, y, this.maxSightRange, dir, function(x, y, range, visibility){
		...
		update180: function(x, y, dir){
            this.fovMap.reset();
            var _this = this;
            this._fov.compute180(x, y, this.maxSightRange, dir, function(x, y, range, visibility){
